...
## 功能简述
  通过简单的配置，可以快速生成大部分类型的验证码，旨在解决机器学习训练样本难以获取的问题，降低训练样本的获取成本。
...
* <code>colors</code>:  整型数组，验证码中字体颜色的集合，单个元素的值为颜色的6位16进制，以"0x"开头。  
...
* <code>char_tran</code>:  浮点型数组，验证码中字符可选的透明度集合，单个元素取值范围[0.0,10.0]。    
